...
urlpatterns = [
    ...
    path('<uuid:event_id>/item/<uuid:item_id>/case-split/<uuid:case_split_id>/commit/<int:commit_id>/delete/', views.case_split_commit_delete, name='events-case-split-commit-delete'),
    path('<uuid:event_id>/item/<uuid:item_id>/case-split/<uuid:case_split_id>/delete/', views.case_split_delete, name='events-case-split-delete'),
